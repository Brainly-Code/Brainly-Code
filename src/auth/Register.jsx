...
const Register = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      // Hardcoding role to USER as per checkbox logic
      const res = await register({ role: "USER", username, email, password }).unwrap(); 
      console.log(res);
        ...
        <header className="flex flex-col items-center pt-8 w-full">
          <div className="w-full max-w-md px-4 sm:px-6 lg:px-8">
            <div className="bg-[#070045] rounded-lg border-[#3A3A5A] border p-6 shadow-lg">
              ...
              {/* These elements have been moved outside the form */}
