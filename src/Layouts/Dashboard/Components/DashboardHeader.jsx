...
const DashboardHeader = ({ searchQuery, setSearchQuery }) => {
  ...
  return (
    <div>
      ...
      <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between mx-auto text-white sm:w-[97%] w-5/6 gap-4">
        <BrainlyCodeIcon className=" mx-auto " />
        <h1 className="text-center text-xl hidden lg:block font-bold mr-[3rem] text-white">
          ADMIN DASHBOARD
        </h1>
        {/* Profile + Logout */}
        <ul className="flex justify-between order-1 sm:order-2 gap-3">
