...
const Login = () => {
  ...
  const handleContinue = (e) => {
    e.preventDefault();
    //  you'll add email  validation here 
      ...
      <div className='min-h-screen bg-[#070045] text-white flex flex-col items-center justify-between'>
        <header className="flex flex-col items-center pt-6 w-full">
          <div className="w-full max-w-md px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-center text-gray-400 mb-8">Sign in to your Brainly code account</p>
              ...
              <form onSubmit={submitHandler} className="flex flex-col items-center">
                {!open ? ( 
                  <>
                    ...
                    <div className="flex justify-between items-center w-full mb-6 text-sm">
                      <div className="flex items-center">
                        <input type="checkbox" name="rememberMe" id="rememberMe" className="form-checkbox h-4 w-4 text-[#8A2BE2] bg-gray-700 border-gray-600 rounded focus:ring-[#8A2BE2]" />
                        <label htmlFor="rememberMe" className="ml-2 text-gray-400">Remember Me</label>
                      </div>
                      <Link to="#" className="text-[#8A2BE2] hover:underline">Forgot Password?</Link>
                    </div>
                  ...
                  <div className="flex justify-between gap-3">
                    ...
                    <button type='button' className='w-full flex items-center justify-center bg-[#00137462] text-gray-300 py-3 rounded-full mb-3 hover:bg-[#001374a9] transition duration-300'>
                      <FaGoogle className='inline mr-3 text-lg' />
                      Continue With Google
                    </button>
                    <button type='button' className='w-full flex items-center justify-center bg-[#00137462] text-gray-300 py-3 rounded-full mb-6 hover:bg-[#001374a9] transition duration-300'>
                      <FaGithub className='inline mr-3 text-lg' />
                      Continue With Github
                    </button>

                   
                    <p className='text-gray-400'>Don't have an account? <Link to={'/register'} className='ml-1 text-[#8A2BE2] hover:underline'>Sign Up</Link></p>
                  </>
                ) : ( 
                  <>
